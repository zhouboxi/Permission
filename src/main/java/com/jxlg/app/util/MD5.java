...
public class MD5 {
	...
	public static void main(String args[]) {
		...
		if (Array.getLength(args) == 0) { // 如果没有参数，执行标准的Test Suite
			...
			System.out.println("MD5(\"a\"):" + m.getMD5ofStr("jun12258"));
		...
		System.out.println("3333333333----->>>"+getMd5CommsBinary("jun12258"));
